...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(uint64_t) consume_Windows_Graphics_Capture_IDirect3D11CaptureFrame3<D>::ConfigurationIteration() const
    {
        uint64_t value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(uint64_t) consume_Windows_Graphics_Capture_IDisplayGraphicsCaptureSession<D>::SetWindowExclusionList(param::iterable<winrt::Windows::UI::WindowId> const& excludedWindows) const
    {
        uint64_t result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::UI::WindowId>) consume_Windows_Graphics_Capture_IDisplayGraphicsCaptureSession<D>::GetWindowExclusionList() const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(uint64_t) consume_Windows_Graphics_Capture_IGraphicsCaptureSession7<D>::ConfigurationIteration() const
    {
        uint64_t value{};
