...
WINRT_EXPORT namespace winrt::Windows::Graphics::Capture
{
    ...
    struct __declspec(empty_bases) IDirect3D11CaptureFrame3 :
        winrt::Windows::Foundation::IInspectable,
    ...
    struct __declspec(empty_bases) IDisplayGraphicsCaptureSession :
        winrt::Windows::Foundation::IInspectable,
    ...
    struct __declspec(empty_bases) IGraphicsCaptureSession7 :
        winrt::Windows::Foundation::IInspectable,
